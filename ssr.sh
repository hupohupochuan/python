...
#451  [2024-05-01 16:41:28][root][223.167.234.213]   cd /etc/init.d
# 452  [2024-05-01 16:42:30][root][223.167.234.213]   /etc/init.d/ssr start
...
BBR_installation_status(){
	if [[ ! -e ${BBR_file} ]]; then
		...
		cd "${file}"
		if ! wget -N --no-check-certificate https://raw.githubusercontent.com/hupohupochuan/python.bak/master/bbr.sh; then
